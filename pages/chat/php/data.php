...
while ($row = mysqli_fetch_assoc($query)) {
    ...
    $output .= '<a href="chat.php?user_id=' . $row['unique_id'] . '">
                    ...
                    <div style="display: flex; align-items: center;white-space:nowrap;margin-right: 5px;color: #gray; font-size: 11px;" class="data-time">' . date('d/m/Y H:i', strtotime($row2['date_time']))  . '<i style="margin-left: 7px;color: #gray" class="far fa-clock"></i></div>
